        ...
        <>
          ...
          <div className="absolute left-0 right-0 border-b bg-white shadow-xl animate-in slide-in-from-top-2 duration-200">
            ...
            {isAdmin && (
                ...
                {isAdmin && (
                  ...
                  <Link
                    ...
                    <div className="mt-4 pt-4 border-t border-slate-100">
                      <Link
                        href="/"
                        className="flex items-center gap-2 rounded-lg px-3 py-2 text-xs font-medium text-slate-500 hover:bg-slate-50 hover:text-slate-700 transition-colors"
                      >
                        <svg className="h-3.5 w-3.5" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
                ...
                {/* Non-admin: back to site link */}
                {!isAdmin && (
                  <div className="flex flex-col justify-end">
                    <div className="pt-4 border-t border-slate-100 md:border-t-0 md:pt-0">
                      <Link
                        href="/"
                        className="flex items-center gap-2 rounded-lg px-3 py-2 text-xs font-medium text-slate-500 hover:bg-slate-50 hover:text-slate-700 transition-colors"
                      >
